...
<title>Enviar los boletines</title>
	<meta charset="UTF-8">
	...
	<section class="full-box cover dashboard-sideBar">
		...
		<div class="full-box dashboard-sideBar-ct">
			...
			<div class="full-box text-uppercase text-center text-titles dashboard-sideBar-title">
				ÚLTIMO PASO <i class="zmdi zmdi-close btn-menu-dashboard visible-xs"></i>
			</div>
			<!-- SideBar User info -->
...
<section class="full-box dashboard-contentPage">
		...
		<img src="https://wmail.smn.gov.ar/skins/outlook/skin/images/login.jpg"  alt="UserIcon">  
			<div class="page-header">
			  <h1 class="text-titles"><i class="zmdi zmdi-balance zmdi-hc-fw"></i> Envio de los Boletines <small>para la METAREA VI.</small></h1>
			</div>
			<p class="lead">  Recuerde que antes de enviar estos boletines tiene que:</p>
			<p>- Tener generado el pronostico en MeteoFactory</p>
			<p>- Cargado los temporales</p>
			<p>- Cargada la situacion sinoptica</p>
			<p>- Copiado y pegado los hielos </p>
		</div>
		
		
		
	 <form method="POST" action=" /NicoMetareaVI/ControladorGenerarBoletines">
									    
							 <p class="text-center">
							<button href="#!" class="btn btn-info btn-raised btn-sm"><i class="zmdi zmdi-floppy"></i> Generar boletines</button>
							</p>
