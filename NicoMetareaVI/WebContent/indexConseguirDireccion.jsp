	...
	<section class="full-box cover dashboard-sideBar">
		...
		<div class="full-box dashboard-sideBar-ct">
			...
			<div class="full-box text-uppercase text-center text-titles dashboard-sideBar-title">
				Conseguir direccion servidor <i class="zmdi zmdi-close btn-menu-dashboard visible-xs"></i>
			</div>
			<!-- SideBar User info -->
...
<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles"><i class="zmdi zmdi-balance zmdi-hc-fw"></i> DIRECCION SERVIDOR <small>aca se guardan los archivos.</small></h1>
			</div>
	
		</div>
		
		
		<form method="POST" action=" /NicoMetareaVI/ControladorConseguirDireccion">
										    ...
										    <p class="text-center">
										    	<button href="#!" class="btn btn-info btn-raised btn-sm"><i class="zmdi zmdi-floppy"></i> La direccion es...</button>
										    </p>
