...
<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles"><i class="zmdi zmdi-balance zmdi-hc-fw"></i> UPPPS!!!! Ha ocurrido un error...<small>vuelva a realizar su última acción.</small></h1>
			</div>
			<p class="lead">De persistir este error por favor llamenos: 
			1-----
			2-----
			3-----
			</p>
			...
			<div class="row">
				<div class="col-xs-12">
					<ul class="nav nav-tabs" style="margin-bottom: 15px;">
					  	...
					  	<li class="active"><a href="#fenomenos" data-toggle="tab"> 0% completada su última acción... </a></li>
