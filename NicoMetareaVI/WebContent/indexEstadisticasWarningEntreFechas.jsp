...
<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles"><i class="zmdi zmdi-balance zmdi-hc-fw"></i> ESTADISTICAS <small>para un determinado periodo.</small></h1>
			</div>
			<p class="lead">Elija entre que fechas desea el reporte.</p>
			...
			<div class="row">
				<div class="col-xs-12">
					<ul class="nav nav-tabs" style="margin-bottom: 15px;">
					  	...
					  	<li class="active"><a href="#avisos" data-toggle="tab"><i class="zmdi zmdi-balance"></i> Fechas</a></li>
					...
					<div class="tab-content">
						...
						<div class="table-responsive">
									   ...
									   <form method="POST" action=" /NicoMetareaVI/ControladorEstadisticasWarningEntreFechas">
										    ...
										    <p class="text-center">
										    	<button href="#!" class="btn btn-info btn-raised btn-sm"><i class="zmdi zmdi-floppy"></i> Consultar</button>
										    </p>
