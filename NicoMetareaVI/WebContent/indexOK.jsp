...
<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles"><i class="zmdi zmdi-balance zmdi-hc-fw"></i> Se han generado sin problema...<small>todos los boletines para la navegación.</small></h1>
			</div>
			<p class="lead">Si desea verlos puede ir a la solapa VER ULTIMOS BOLETINES</p>
		</div>
			...
			<div class="row">
				<div class="col-xs-12">
					<ul class="nav nav-tabs" style="margin-bottom: 15px;">
					  	...
					  	<li class="active"><a href="#fenomenos" data-toggle="tab"> 100% completado el envio... </a></li>
