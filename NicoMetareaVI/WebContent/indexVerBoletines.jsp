	...
	<section class="full-box cover dashboard-sideBar">
		...
		<div class="full-box dashboard-sideBar-ct">
			...
			<div class="full-box text-uppercase text-center text-titles dashboard-sideBar-title">
				ULTIMOS BOLETINES <i class="zmdi zmdi-close btn-menu-dashboard visible-xs"></i>
			</div>
			<!-- SideBar User info -->
...
<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles"><i class="zmdi zmdi-balance zmdi-hc-fw"></i> ULTIMOS BOLETINES <small>generados por ultima vez.</small></h1>
			</div>
			<p class="lead">Selecciones cual de los boletines desea ver.</p>
		</div>
			...
			<section id="cd-timeline" class="cd-container">
                ...
                <div class="cd-timeline-block">
                    ...
                    <div class="cd-timeline-img">
                        <img src="./assets/img/smn.jpg" alt="user-picture">
                    </div>
                    ...
                    <div class="cd-timeline-content">
                        ...
                        <a href="HS.jsp" target="_blank">
                            <i class="zmdi zmdi-power zmdi-hc-fw"></i> High Sea - Ingles
                            </a>
                        </p>
                        
                        <p class="text-center">
                        
                        <a href="HSE.jsp" target="_blank">
                            <i class="zmdi zmdi-power zmdi-hc-fw"></i> High Sea - Español
                            </a>
                        </p>
                        <span class="cd-date"><i class="zmdi zmdi-calendar-note zmdi-hc-fw"></i> 1 - Boletin de Alta Mar</span>
                    </div>
                ...
                <div class="cd-timeline-block">
                    ...
                    <div class="cd-timeline-content">
                        ...
                        <p class="text-center">
                        <a href="OFF.jsp" target="_blank">
                            <i class="zmdi zmdi-power zmdi-hc-fw"></i>  Off Shore - Ingles
                         </a>
                        </p>
                        
                         <p class="text-center">
                        <a href="OFFE.jsp" target="_blank">
                            <i class="zmdi zmdi-power zmdi-hc-fw"></i> Off Shore - Español
                         </a>
                        </p>
                        <span class="cd-date"><i class="zmdi zmdi-calendar-note zmdi-hc-fw"></i> 2 - Boletin de Off Shore</span>
                    </div>
                </div>
                ...
                <div class="cd-timeline-block">
                    ...
                    <div class="cd-timeline-content">
                        ...
                        <p class="text-center">
                        <a href="TODOS.jsp" target="_blank">
                            <i class="zmdi zmdi-power zmdi-hc-fw"></i> Warning - Ingles
                        </a>
                        </p>
                        
                         <p class="text-center">
                        <a href="TODOSE.jsp" target="_blank">
                            <i class="zmdi zmdi-power zmdi-hc-fw"></i> Warning - Español
                        </a>
                        </p>
                        <span class="cd-date"><i class="zmdi zmdi-calendar-note zmdi-hc-fw"></i> 3 - Boletin de Warning</span>
                    </div>
                </div>
                  ...
                  <div class="cd-timeline-block">
                    ...
                    <div class="cd-timeline-content">
                         ...
                         <p class="text-center">
                        <a href="COSTASE.jsp" target="_blank">
                            <i class="zmdi zmdi-power zmdi-hc-fw"></i> Pronostico
                        </a>
                        </p>
                        <span class="cd-date"><i class="zmdi zmdi-calendar-note zmdi-hc-fw"></i> 4 - Warning y Pronosticos Costas</span>
                    </div>
                </div>
	...
	<div class="modal fade" tabindex="-1" role="dialog" id="Dialog-Help">
	  	<div class="modal-dialog" role="document">
		    ...
		    <div class="modal-header">
			    ...
			    <div class="modal-header">
			        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
			    	<h4 class="modal-title">En esta pestaña usted podra ver los ultimos boletines: </h4>
			    </div>
			    ...
			    <div class="list-group-item" ALIGN="justify">
			        	...
			        	<h6> Estos boletines seran los enviados por medio de MeteoFactory.  </h6>
