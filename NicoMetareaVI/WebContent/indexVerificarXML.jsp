...
<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles"><i class="zmdi zmdi-balance zmdi-hc-fw"></i> El XML .... <small>¿Es el del dia de hoy?.</small></h1>
			</div>
			<p class="lead">De no ser asi, reenvie el XML con PiMet, o aguarde y vuelva a verificar.</p>
		</div>
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-xs-12">
					<ul class="nav nav-tabs" style="margin-bottom: 15px;">
					  	...
					  	<li class="active"><a href="#fenomenos" data-toggle="tab"><i class="zmdi zmdi-balance"></i> El pronostico es el cargado el: </a></li>
				...
				<% String retorno = Funciones.generarPronosticos(p);
				String retornoOFF = Funciones.generarPronosticosOFFSHORE(p);
				String retornoCoastal = Funciones.generarPronosticosCoastal(p);
				
				
				errores = Funciones.contarCaracteres(retorno, 'X');
				erroresOFF = Funciones.contarCaracteres(retornoOFF, 'X');
				erroresCoastal = Funciones.contarCaracteres(retornoCoastal, 'X');%>	
		 ...
		 <% String fecha = String.valueOf(p.getIdPronostico()).replace(".", ""); %>
		 <% String fechaReducida =  fecha.substring(0, 12)   ;
		 fechaReducida = fechaReducida +"</br></br>"+"Cantidad de errores:              " +errores
		 +"</br></br>"+"Cantidad de errores OFFSHORE:   " +erroresOFF+"</br></br>"
		 +"Cantidad de errores Costeros:    " +erroresCoastal; %>
					  
					 
					  
					  
					   <li class="active"><a href="#fenomenos" data-toggle="tab"><%=fechaReducida%> </a></li>
