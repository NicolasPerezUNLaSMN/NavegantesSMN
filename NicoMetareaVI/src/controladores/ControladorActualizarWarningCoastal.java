...
public class ControladorActualizarWarningCoastal extends HttpServlet {
...
private void procesarPeticion(HttpServletRequest request, HttpServletResponse response)
			...
			try {
				...
				Warning warningAct = wABM.traerWarning(idWarning);
				
				//Numero de warning DESPUES VEO COMO GENERARLO
				int numeroWarning = warningAct.getNumeroWarning();
				int actWarning = warningAct.getActualizacion()+1;
	...
	GregorianCalendar hoy = new GregorianCalendar();
				...
				String warning = "WWST06  SABM  " +diaString +horaUTCSalida +"00" +"\r\n1:31:06:01:00 \r\nSECURITE\r\nCOASTAL WARNING FOR METAREA VI ISSUED BY SMN ARGENTINA " +diaString +" "+FuncionesNico.traerMesEnLetrasIngles(hoy) +anio +"/" +horaUTCSalida +"00"+".\r\n";
				...
				//warning = warning.replace("FORECAST:", "PRONOSTICO:");
				...
				Warning ceso = wABM.traerWarning(idWarning);
				ceso.setActivo(0);
				wABM.modificar(ceso);
