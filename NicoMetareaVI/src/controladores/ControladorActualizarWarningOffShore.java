...
public class ControladorActualizarWarningOffShore extends HttpServlet {
...
private void procesarPeticion(HttpServletRequest request, HttpServletResponse response)
	...
	GregorianCalendar hoy = new GregorianCalendar();
				...
				String warning = "WWST04  SABM  " +diaString +horaUTCSalida +"00" +"\r\n1:31:06:01:00 \r\nSECURITE\r\nOFFSHORE WARNING FOR METAREA VI ISSUED BY SMN ARGENTINA " +diaString +" "+FuncionesNico.traerMesEnLetrasIngles(hoy) +anio +"/" +horaUTCSalida +"00"+".\r\n";
				String fuerzaViento = " ";
				switch (tipo) {
